...
## `ResourceLoader`
This is the base class for all resource loaders. It provides a loading mechanism that understands the relativity of file locations, and has methods for loading and unloading resources.
...
## `SoundSheet` loader
Sounds are defined into `SoundSheets` to organize sounds for easy reference.
