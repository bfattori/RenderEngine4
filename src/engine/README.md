...
## Engine Parts
 ...
 - **`/core`** - The engine proper, including the `Engine`, `EventEngine`, `GameWorld`, `Console`, and various utilities
 ...
 - **`/ui`** - User interface components, debug components, the vector font, and other user interface-related code
